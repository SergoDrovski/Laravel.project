            ...
            <nav class="navbar navbar-expand-md">
                ...
                <div id="my-nav" class="collapse navbar-collapse">
                    <ul class="navbar-nav mx-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="article.html">НОВОСТИ</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="article.html">ИСТОРИЯ</a>
                        </li>
                        <li class="nav-item">
...
<div class="container-fluid">
    <div class="container">
        ...
        <div class="row vr-gallery">
            <a href=""><div class="col-md-8 mb-4">
                    <div class="row">
            ...
            <hr>
            <a href=""><div class="col-md-4 pl-4 mb-4">
                    <div class="card">
            ...
            <hr>
            <a href=""><div class="col-md-8 mb-4 pr-0 pd-md">
                    <div class="card">
            ...
            <hr>
            <a href=""><div class="col-md-12 text-center"></div></a>
